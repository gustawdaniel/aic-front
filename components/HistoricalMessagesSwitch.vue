...
import { useHistoricalMessagesEnabled } from "~/composables/historicalMessagesEnabled";
...
<template>
  <SwitchGroup as="div" class="flex items-center justify-between">
    <span class="flex flex-grow flex-col">
      <SwitchLabel as="span" class="text-sm font-medium leading-6 text-gray-900" passive>Add Historical Messages</SwitchLabel>
      <SwitchDescription as="span" class="text-sm text-gray-500">Is context of previous processing included.</SwitchDescription>
    </span>
